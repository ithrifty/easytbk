...
use EasyTBK\Kernel\Contracts\AccessTokenInterface;
use EasyTBK\Kernel\Http\Response;
use EasyTBK\Kernel\Traits\HasHttpRequests;
...
class BaseClient
{
    ...
    /**
     * @var \EasyTBK\Kernel\ServiceContainer
     */
    protected $app;
    /**
     * @var \EasyTBK\Kernel\Contracts\AccessTokenInterface|null
     */
     ...
     *
     * @param \EasyTBK\Kernel\ServiceContainer                    $app
     * @param \EasyTBK\Kernel\Contracts\AccessTokenInterface|null $accessToken
     */
     ...
     * @param array  $query
     *
     * @return \Psr\Http\Message\ResponseInterface|\EasyTBK\Kernel\Support\Collection|array|object|string
     *
    ...
    /**
     * @param \EasyTBK\Kernel\Contracts\AccessTokenInterface $accessToken
     *
     * @return $this
     */
    ...
    {
        $options = $this->app->getOptions($options, $method);
     ...
     * @param array  $options
     *
     * @return \EasyTBK\Kernel\Http\Response
     *
     * @throws \EasyTBK\Kernel\Exceptions\InvalidConfigException
     * @throws \GuzzleHttp\Exception\GuzzleException
     */
